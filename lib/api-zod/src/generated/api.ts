...
export const CreateMeetingBody = zod.object({
  ...
  "endTime": zod.coerce.date(),
  "organizerId": zod.number(),
  "participantIds": zod.array(zod.number()).min(1),
...
/**
 * @summary Get all meetings for today
 */
...
/**
 * @summary Get all meetings for current week
 */
...
/**
 * @summary Check if a time slot has conflicts
 */
